      ...
      <form onSubmit={this._onSubmit} >
        <div className="row">
          <div className="form-group">
            ...
            <div className="col-sm-4">
              <input type="text" className="form-control" placeholder="Holly" ref="firstName" required/>
            </div>
          </div>
        </div>
        <br/>
        <div className="row">
          <div className="form-group">
            ...
            <div className="col-sm-4">
              <input type="text" className="form-control" placeholder="Zhou" ref="lastName" required/>
            </div>
          </div>
        </div>
        <br/>
